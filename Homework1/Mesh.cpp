...
CTexturedSqureMesh::CTexturedSqureMesh(ComPtr<ID3D12Device>& pd3dDevice, ComPtr<ID3D12GraphicsCommandList>& pd3dCommandList, float width, float height)
{
	...
	m_vVertices.push_back(TexturedVertex(XMFLOAT3(-hWidth, hHeight, 0.0f), XMFLOAT2(0.0f, 0.0f)));
	m_vVertices.push_back(TexturedVertex(XMFLOAT3(hWidth, hHeight, 0.0f), XMFLOAT2(1.0f, 0.0f)));
	m_vVertices.push_back(TexturedVertex(XMFLOAT3(hWidth, -hHeight, 0.0f), XMFLOAT2(1.0f, 1.0f)));
	m_vVertices.push_back(TexturedVertex(XMFLOAT3(-hWidth, -hHeight, 0.0f), XMFLOAT2(0.0f, 1.0f)));
