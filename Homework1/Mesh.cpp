...
// fSize = 반지름
CTexturedSquareMesh::CTexturedSquareMesh(ComPtr<ID3D12Device>& pd3dDevice, ComPtr<ID3D12GraphicsCommandList>& pd3dCommandList, 방향 arrow, float fSize)
{
	m_vVertices.reserve(4);
	m_vIndices.reserve(6);
	...
	switch (arrow) {
	case 좌:
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(-fSize, fSize, -fSize), XMFLOAT2(0.0f, 0.0f)));
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(-fSize, fSize, fSize), XMFLOAT2(1.0f, 0.0f)));
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(-fSize, -fSize, fSize), XMFLOAT2(1.0f, 1.0f)));
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(-fSize, -fSize, -fSize), XMFLOAT2(0.0f, 1.0f)));
		break;
	case 우:
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(fSize, fSize, fSize), XMFLOAT2(0.0f, 0.0f)));
		m_vVertices.push_back(TexturedVertex(XMFLOAT3(fSize, fSize, -fSize), XMFLOAT2(1.0f, 0.0f)));
